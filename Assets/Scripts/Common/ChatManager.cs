...
public class ChatManager : Singleton<ChatManager>
{
    ...
    private bool MessageFadeOut(int messageIndex)
    {
        ...
        else
        {
            ...
            messageList[messageIndex].transform.localPosition = new Vector3(messageList[messageIndex].transform.localPosition.x, (-66 - 70 * messageIndex), messageList[messageIndex].transform.localPosition.z);
            return false;
        }
    }

...
public class MultiMeshPatchManager : MonoBehaviour
{
    ...
    {
        Destroy(MultiMeshManager.Instance.PatchList[MultiMeshManager.Instance.PatchList.Count - 1].OuterPatch);
        Destroy(MultiMeshManager.Instance.PatchList[MultiMeshManager.Instance.PatchList.Count - 1].InnerPatch);
    ...
    {
        MultiMeshManager.Instance.PatchList[patchIndex].OuterPatch.GetComponent<MeshFilter>().mesh.RecalculateNormals();
        MultiMeshManager.Instance.PatchList[patchIndex].InnerPatch.GetComponent<MeshFilter>().mesh.RecalculateNormals();
        // 0.5를 기준으로 하는게 나을 듯.
    ...
    private void GeneratePatchObj()
    {
        ...
        GameObject patchObj = MultiMeshManager.Instance.PatchList[MultiMeshManager.Instance.PatchList.Count - 1].OuterPatch;
        Mesh mesh = new Mesh();
    ...
    private void CalculateNormal()
    {
        ...
        Mesh mesh = MultiMeshManager.Instance.PatchList[_patchIndex].OuterPatch.GetComponent<MeshFilter>().mesh;
        ...
        mesh.RecalculateNormals();
        MultiMeshMakeDoubleFace.Instance.MakePatchInnerFace(MultiMeshManager.Instance.PatchList[_patchIndex].OuterPatch);
        return;
    }
    ...
    {
        Mesh mesh = MultiMeshManager.Instance.PatchList[patchIndex].OuterPatch.GetComponent<MeshFilter>().mesh;
        ...
        mesh.vertices = patchVertexPosition;
        MultiMeshMakeDoubleFace.Instance.PatchUpdateInnerFaceVertices(patchIndex);
    }
    ...
    private void GeneratePatchObjForMeasure(int MeshIndex)
    {
        ...
        float diamterByFaces = Mathf.Sqrt(area / Mathf.PI) * 2 / MultiMeshManager.Instance.objsTransform[MeshIndex].lossyScale.z;
        ...
        diamterByCircumference = diamterByCircumference / Mathf.PI / MultiMeshManager.Instance.objsTransform[MeshIndex].lossyScale.z;
